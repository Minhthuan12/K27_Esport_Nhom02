                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="input-group">
                                <span class="input-group-text fw-bold bg-primary text-white">Từ ngày</span>
                                <input v-model="khoang_ngay.tu_ngay" type="date" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="input-group">
                                <span class="input-group-text fw-bold bg-primary text-white">Đến ngày</span>
                                <input v-model="khoang_ngay.den_ngay" type="date" class="form-control">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <button @click="thongKe" class="btn btn-primary text-white w-100 fw-bold">
                                <i class="bx bx-football"></i> Lọc Biểu Đồ
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-header bg-primary text-white py-3">
                            <h5 class="mb-0 text-white fw-bold text-uppercase fs-6">
                                <i class="bx bx-calendar-event"></i> Bảng Trận Đấu Theo Tháng
                            </h5>
                        </div>
                                ...
                                <table class="table table-bordered table-hover mb-0 align-middle">
                                    ...
                                    <tbody>
                                        <tr v-for="(value, index) in list_data" :key="index">
                                            ...
                                            <td class="text-center fw-bold text-primary">{{ value.so_tran_dau }} trận</td>
                                        </tr>
                ...
                <div class="col-lg-7 mb-3">
                    <div class="card shadow-sm h-100">
                        <div class="card-header bg-primary text-white py-3">
                            <h5 class="mb-0 text-white fw-bold text-uppercase fs-6">
                                <i class="bx bx-line-chart"></i> Biểu Đồ Số Trận Đấu Theo Tháng
                            </h5>
                        </div>
...
export default {
    ...
    methods: {
        thongKe() {
            this.is_load = false;
            axios.get('http://127.0.0.1:8000/api/admin/thong-ke/nhom-5/cau-1', { params: this.khoang_ngay })
                .then((res) => {
                ...
                .catch(error => {
                    console.error("Lỗi lấy dữ liệu thống kê Nhóm 5 - Câu 1:", error);
                    this.is_load = true;
                });
        }
    }
