                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-2">
                            <button @click="thongKe" class="btn btn-purple text-white w-100 fw-bold">
                                <i class="bx bx-user-plus"></i> Lọc Biểu Đồ
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="card shadow-sm h-100">
                        <div class="card-header bg-purple text-white py-3">
                            <h5 class="mb-0 text-white fw-bold text-uppercase fs-6">
                                <i class="bx bx-user-check"></i> Bảng Đăng Ký Tài Khoản Theo Tháng
                            </h5>
                        </div>
                                ...
                                <table class="table table-bordered table-hover mb-0 align-middle">
                                    ...
                                    <tbody>
                                        <tr v-for="(value, index) in list_data" :key="index">
                                            ...
                                            <td class="text-center fw-bold text-purple">{{ value.so_tai_khoan_moi }} tài khoản</td>
                                        </tr>
                ...
                <div class="col-lg-7 mb-3">
                    <div class="card shadow-sm h-100">
                        <div class="card-header bg-purple text-white py-3">
                            <h5 class="mb-0 text-white fw-bold text-uppercase fs-6">
                                <i class="bx bx-line-chart font-22"></i> Biểu Đồ Tăng Trưởng Người Dùng Mới Theo Tháng
                            </h5>
                        </div>
...
export default {
    ...
    methods: {
        thongKe() {
            this.is_load = false;
            axios.get('http://127.0.0.1:8000/api/admin/thong-ke/nhom-7/cau-1', { params: this.khoang_ngay })
                .then((res) => {
                ...
                .catch(error => {
                    console.error("Lỗi lấy dữ liệu thống kê Nhóm 7 - Câu 1:", error);
                    this.is_load = true;
                });
        }
    }
