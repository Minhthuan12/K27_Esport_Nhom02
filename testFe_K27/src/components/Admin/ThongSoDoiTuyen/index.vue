<template>
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card border-top border-3 border-primary shadow-sm">
                <div class="card-header bg-transparent">
                    <b class="text-uppercase text-dark">Thêm Mới Chỉ số Đội tuyển</b>
                </div>
                <div class="card-body">
                    <div class="mb-2">
                    ...
                    <div class="mb-2">
                        <label class="form-label">Số giải nhất</label>
                        <input type="number" class="form-control form-control-sm" value="0">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Số giải nhì</label>
                        <input type="number" class="form-control form-control-sm" value="0">
                    </div>
                    <div class="mb-2">
                        <label class="form-label">Số giải ba</label>
                        <input type="number" class="form-control form-control-sm" value="0">
                    </div>
                    <div class="mb-2">
        ...
        <div class="col-lg-8">
            <div class="card border-top border-3 border-primary shadow-sm">
                <div class="card-header bg-transparent">
                    <b class="text-uppercase text-dark">Danh Sách Chỉ Số Đội Tuyển</b>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover mb-0 text-nowrap">
                            ...
                            <tbody>
                                <tr v-for="(thongSo, index) in list_thong_so" :key="thongSo.id">
                                    ...
                                    <td class="text-center align-middle">{{ thongSo.so_giai_nhat }}</td>
                                    <td class="text-center align-middle">{{ thongSo.so_giai_nhi }}</td>
                                    <td class="text-center align-middle">{{ thongSo.so_giai_ba }}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Cập nhật chỉ số đội tuyển</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2">
                        <label class="form-label fw-semibold">Số giải nhất</label>
                        <input type="number" class="form-control form-control-sm" value="1">
                    </div>
                    <div class="mb-2">
                        <label class="form-label fw-semibold">Số giải nhì</label>
                        <input type="number" class="form-control form-control-sm" value="1">
                    </div>
                    <div class="mb-2">
                        <label class="form-label fw-semibold">Số giải ba</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger" role="alert">
                        Bạn có chắc chắn muốn xóa chỉ số của đội <strong>Cerberus Esports</strong> này không?
                    </div>
                </div>
...
export default {
    ...
    methods: {
        loadData() {
            axios.get('http://127.0.0.1:8000/api/admin/thong-so-doi-tuyen/get-data')
                .then(response => {
