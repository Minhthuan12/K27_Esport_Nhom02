    ...
    group.questions.forEach((q) => {
        ...
        const routeCell = new TableCell({
            ...
            borders: {
                ...
                left: { style: BorderStyle.SINGLE, size: 24, color: "3182CE" }, // Blue left border line
        ...
        children.push(
            new Paragraph({
                ...
                children: [
                    new TextRun({ text: "-Methods: ", bold: true, size: 22 }),
        ...
        children.push(
            new Paragraph({
                ...
                children: [
                    new TextRun({ text: "-Controller: ", bold: true, size: 22 }),
        ...
        const imageCell = new TableCell({
            children: [
                new Paragraph({
                    ...
                    children: [
                        new TextRun({
                            text: "[ KHUNG DÁN ANH KẾT QUẢ / BIỂU ĐỒ MẪU ]",
                            color: "A0AEC0",
                            italic: true,
                            size: 20
                        })
...
Packer.toBuffer(doc).then((buffer) => {
    ...
    console.log('✅ Đã tạo file Word thành công tại: ' + outputPath);
}).catch(err => {
